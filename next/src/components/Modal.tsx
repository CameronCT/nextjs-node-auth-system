...
const Modal = (props: IProps) => {
    ...
    return (
        <div
            ...
            className={`modal-bg fixed inset-0 w-full h-screen bg-black bg-opacity-50 transition-all ease-in-out duration-300 ${props.isOpened ? 'opacity-100 visible' : 'opacity-0 pointer-events-none invisible'}`}
        >
